...
{
    public partial class FrmRaporSu : Form
    {
        public FrmRaporSu()
        {
            InitializeComponent();
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem secilenkayitbilgisi in listRapor.CheckedItems)
            {
                ...
                SqlCommand komut = new SqlCommand("DELETE from RaporSu WHERE AdSoyad='" + name + "'", baglanti);
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            if (sil == DialogResult.Yes)
            {
                ...
                baglanti.Open();
                SqlCommand komut = new SqlCommand("DELETE from RaporSu", baglanti);
                komut.ExecuteNonQuery();
                baglanti.Close();
        ...
        private void FrmRaporSu_Load(object sender, EventArgs e)
        {
            kayitsayisiyaz();
            verilerigoster();
        }
