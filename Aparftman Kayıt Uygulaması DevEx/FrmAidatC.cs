...
{
    public partial class FrmAidatC : Form
    {
        public FrmAidatC()
        {
            InitializeComponent();
        ...
        private void verilerigoster()
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * from BlokC", baglanti);
        ...
        private void aidatBtnCGoster_Click(object sender, EventArgs e)
        {
            verilerigoster();
        }

        private void FrmAidatC_Load(object sender, EventArgs e)
        {
            verilerigoster();
        }
        ...
        private void aidatBtnCTemizle_Click(object sender, EventArgs e)
        {
            textBox1.Text = "";
            textBox2.Text = "";
            textBox3.Text = "";
        ...
        private void btnCikar_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("update BlokC set Borc='" + textBox7.Text.ToString() + "' where id=" + id + "", baglanti);
