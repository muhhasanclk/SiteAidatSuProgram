...
{
    public partial class FrmAidatB : Form
    {
        public FrmAidatB()
        {
            InitializeComponent();
        ...
        private void verilerigoster()
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * from BlokB", baglanti);
        ...
        private void aidatBtnBGoster_Click(object sender, EventArgs e)
        {
            verilerigoster();
        }

        private void FrmAidatB_Load(object sender, EventArgs e)
        {
            verilerigoster();
        }
        ...
        private void aidatBtnBTemizle_Click(object sender, EventArgs e)
        {
            textBox1.Text = "";
            textBox2.Text = "";
            textBox3.Text = "";
        ...
        private void btnCikar_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("update BlokB set Borc='" + textBox7.Text.ToString() + "' where id=" + id + "", baglanti);
