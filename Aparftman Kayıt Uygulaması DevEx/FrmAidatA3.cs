...
{
    public partial class FrmAidatA3 : Form
    {
        public FrmAidatA3()
        {
            InitializeComponent();
        ...
        private void verilerigoster()
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * from BlokA3", baglanti);
        ...
        private void aidatBtnA3Goster_Click(object sender, EventArgs e)
        {
            verilerigoster();
        }

        private void FrmAidatA3_Load(object sender, EventArgs e)
        {
            verilerigoster();
        }
        ...
        private void aidatBtnA3Temizle_Click(object sender, EventArgs e)
        {
            textBox1.Text = "";
            textBox2.Text = "";
            textBox3.Text = "";
        ...
        private void btnCikar_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("update BlokA3 set Borc='" + textBox7.Text.ToString() + "' where id=" + id + "", baglanti);
        ...
        private void textBox5_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                e.Handled = true; //Enter'a basinca bing sesini kapatir.
                e.SuppressKeyPress = true;
                btnCikar_Click(this, new EventArgs());
            }
            if (e.KeyCode == Keys.Down)
            {
                SendKeys.Send("{TAB}"); //asagi yon tusuyla tab islevini kullaniyoruz 
            }
        }
